...
public class MoreFilterViewMap extends LinearLayout {
    ...
    public MoreFilterViewMap(Context context) {
        this(context, null);
    }

    public MoreFilterViewMap(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MoreFilterViewMap(Context context, AttributeSet attrs, int defStyleAttr) {
