 ...
 */
public class SecondFragment extends BaseFragment implements  SwipeRefreshLayout.OnRefreshListener,TypeFilterView.MyCallBack
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        searchgo =  view.findViewById(R.id.searchgo);
        goMapBtn=  view.findViewById(R.id.goMapBtn);
        bgView = (LinearLayout) view.findViewById(R.id.bgView);
        typeView = (LinearLayout) view.findViewById(R.id.typeView);

        typeViewIn = (TypeFilterView) view.findViewById(R.id.typeViewIn);


        priceView = (LinearLayout) view.findViewById(R.id.priceView);

        priceViewIn = (PriceFilterView) view.findViewById(R.id.priceViewIn);


        areaView = (LinearLayout) view.findViewById(R.id.areaView);

        areaViewIn = (AreaFilterView) view.findViewById(R.id.areaViewIn);

        myloading = (RelativeLayout) view.findViewById(R.id.myloading);


        bedsView = (LinearLayout) view.findViewById(R.id.bedsView);

        bedsViewIn = (BedsFilterView) view.findViewById(R.id.bedsViewIn);



        moreView = (LinearLayout) view.findViewById(R.id.moreView);

        moreViewIn = (MoreFilterView) view.findViewById(R.id.moreViewIn);
        ...
        priceViewIn.initLang(getLanguage(),"purchase");

        bedsViewIn.initLang(getLanguage());
        moreViewIn.initLang(getLanguage(),"purchase");

        house_fitle_type_title = (TextView) view.findViewById(R.id.house_fitle_type_title);
        house_fitle_price_title = (TextView) view.findViewById(R.id.house_fitle_price_title);
        house_fitle_beds_title = (TextView) view.findViewById(R.id.house_fitle_beds_title);
        house_fitle_more_title = (TextView) view.findViewById(R.id.house_fitle_more_title);
        house_fitle_area_title
                = (TextView) view.findViewById(R.id.house_fitle_area_title);

        swipeRefreshLayout = (SwipeRefreshLayout) view.findViewById(R.id.main_srl);
        lv = (RecyclerView) view.findViewById(R.id.main_lv);
        ...
        sortBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try{
                    ...
                    LinearLayout vv = (LinearLayout)getActivity().getLayoutInflater().inflate(R.layout.sort, null);
                    ...
                    try{
                        ...
                        if(tem.size()>0){
                            ...
                            for(int i = 0;i < tem.size();i++){
                                ...
                                RelativeLayout rl = (RelativeLayout)getActivity().getLayoutInflater().inflate(R.layout.home_com_view,null);
    ...
    class MyAdapter extends RecyclerView.Adapter<MyAdapter.ViewHolder> {
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int i) {
            ...
            ViewHolder holder = new ViewHolder(LayoutInflater.from(
                    getActivity()).inflate(R.layout.home_house_cell, parent,
                    false));
