...
public class ScheduleActivity extends BaseActivity implements  AbsListView.OnScrollListener{
    ...
    public void onScrollStateChanged(AbsListView view, int scrollState) {
        if(adapter.getCount() == visibleLastIndex && scrollState == SCROLL_STATE_IDLE){
            new ScheduleActivity.LoadDataThread().start();
        }
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener()
        {
            ...
            {
                try{
                    Intent intent =new Intent(ScheduleActivity.this,HouseDetailsActivity.class);
        ...
        if(getLanguage().contains("zh")){
            home_map_title.setText("我的预约");
        }else{
            home_map_title.setText("My schedule");
        }
    ...
    private void removeDatas(int index){
        ...
        String url = "http://api.usleju.cn/member/schedule/remove";
                ...
                try {
                    ...
                    if(code == 200){
                        ...
                        if(getLanguage().contains("zh")){
                            ...
                            Toast.makeText(ScheduleActivity.this, "Remove successfully", Toast.LENGTH_SHORT).show();
                        }
    ...
    private void getHouseDatas(){
        ...
        String url = "http://api.usleju.cn/member/schedule/list";
    ...
    class MyAdapter extends BaseAdapter implements AdapterView.OnItemClickListener{
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            TextView statusLabelaa =     (TextView)house.findViewById(R.id.statusLabelaa);



            try{

                timeLabel.setText(obja.getString("date_start"));
                ...
                if(getLanguage().contains("zh")){
                    ...
                    if(Integer.parseInt(obja.getString("status")) == 0){

                        statusLabelaa.setText("未确认");

                    }else  if(Integer.parseInt(obja.getString("status")) == 1){
                        statusLabelaa.setText("已确认");
                    }
                    ...
                    if(Integer.parseInt(obja.getString("status")) == 0){
                        ...
                        statusLabelaa.setText("unconfirmed");

                    }else  if(Integer.parseInt(obja.getString("status")) == 1){
                        statusLabelaa.setText("confirmed");
                    }
