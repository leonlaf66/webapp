...
- (UITableViewCell *)tableView:(UITableView *)tableView
    ...
    static NSString *identifierb=@"ArticleViewCell";
    ArticleViewCell *cell=[tableView dequeueReusableCellWithIdentifier:identifierb];
    if (cell==nil) {
        
        cell= [[[NSBundle mainBundle]loadNibNamed:@"ArticleViewCell" owner:nil options:nil] firstObject];
    }
