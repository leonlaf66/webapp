...
///     颜色相关
///----------------------
#define kHXColorRGBA(r, g, b, a)         [UIColor colorWithRed:((r) / 255.0) green:((g) / 255.0) blue:((b) / 255.0) alpha:(a)]
#define kHXColorHex(rgbValue,a)          [UIColor colorWithRed:((float)((rgbValue & 0xFF0000) >> 16))/255.0 green:((float)((rgbValue & 0xFF00) >> 8))/255.0 blue:((float)(rgbValue & 0xFF))/255.0 alpha:(a)]
#define kHXFontFisrtBg                                        (kHXColorHex(0x666666))
#define kHXFontSecndBg                                        (kHXColorHex(0x999999))


///----------------------
///     通用颜色 字体 配置(根据项目需求自行配置,主题颜色)
///----------------------
#define kHXBackgroundColor            kHXColorHex(0xF1F1F1,1) // 主背景颜色
#define kHXColorGreen                 kHXColorHex(0x1FBD22,1) // 主题红色
#define kHXFont1Color                 kHXColorHex(0x666666,1) // 字体1号色
#define kHXFont2Color                 kHXColorHex(0x999999,1) // 字体2号色

// 常用颜色
#define GlobalBackgroundColor   kHXColorHex(0xF6F6F6,1)
#define GlobalCountRedColor     kHXColorHex(0xF05E4B,1)

#define GlobalTitleColor        kHXColorHex(0x333333,1)
#define GlobalSubTitleColor     kHXColorHex(0x878787,1)
#define GlobalTextColor         kHXColorHex(0x999999,1)
#define GlobalSeparateLineColor         kHXColorHex(0xDEDEDE,1)
